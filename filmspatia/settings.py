"""
Django settings for filmspatia project.
...
SECRET_KEY = 's#^9pu4h-xy0vjwsiu$a+_4g1g)!rykj$w%rvp_yjs90b(5nf5'
...
INSTALLED_APPS = [
    ...
    'django.contrib.admindocs', #generará la documentación
...
WSGI_APPLICATION = 'filmspatia.wsgi.application'
